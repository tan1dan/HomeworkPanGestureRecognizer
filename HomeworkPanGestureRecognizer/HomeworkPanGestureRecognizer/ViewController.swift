...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        staticView = UIView(frame: CGRect(x: 50, y: 100, width: 100, height: 100))
        ...
        resetButton.frame = CGRect(x: 50, y: 300, width: 200, height: 40)
    ...
    @objc func resetButtonTapped() {
        staticView.frame = CGRect(x: 50, y: 100, width: 100, height: 100)
